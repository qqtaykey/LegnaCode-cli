...
const BUILTIN_PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    baseUrl: process.env.AZURE_OPENAI_ENDPOINT ?? 'https://YOUR_RESOURCE.openai.azure.com',
  ...
  },
  {
    ...
    baseUrl: process.env.VERTEX_ENDPOINT ?? 'https://us-central1-aiplatform.googleapis.com/v1',
